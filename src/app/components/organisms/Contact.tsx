      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-[#F2E7D0]/70 max-w-2xl mx-auto leading-relaxed">
            Estamos listos para hacer realidad el viaje de tus sueÃƒÆ’Ã‚Â±os. ContÃƒÆ’Ã‚Â¡ctanos y te ayudaremos a planificar tu estadÃƒÆ’Ã‚Â­a perfecta.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="group relative">
            ...
            <div className="relative flex flex-col items-center text-center gap-4 p-6 bg-gradient-to-br from-[#2A2520] to-[#1C1815] rounded-2xl border border-[#B58A4F]/20 hover:border-[#B58A4F]/50 transition-all duration-300 hover:-translate-y-1 shadow-xl h-full">
              ...
              <div>
                <h4 className="text-[#F2E7D0] font-serif text-lg mb-2">UbicaciÃƒÆ’Ã‚Â³n</h4>
                <p className="text-[#D8B17A] text-base">Jr. Arequipa 213</p>
                <p className="text-[#F2E7D0]/60 text-xs mt-2">CelendÃƒÆ’Ã‚Â­n, Cajamarca, PerÃƒÆ’Ã‚Âº</p>
              </div>
            </div>
          </div>
        ...
        <div className="flex justify-center mb-12">
          <div className="relative group w-full max-w-4xl">
            ...
            >
              <div>
                <h3 className="text-2xl font-serif text-[#F2E7D0] mb-2">EnvÃƒÆ’Ã‚Â­anos un Mensaje</h3>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-[#F2E7D0] mb-2 text-sm font-medium">TelÃƒÆ’Ã‚Â©fono</label>
                  <input
                    type="tel"
                    name="phone"
              ...
              <div>
                ...
                <textarea
                  ...
                  name="message"
                  required
                  placeholder="CuÃƒÆ’Ã‚Â©ntanos sobre tu viaje ideal, fechas de tu estadÃƒÆ’Ã‚Â­a, nÃƒÆ’Ã‚Âºmero de personas..."
              ...
              {status === 'success' && (
                <div className="flex items-center gap-3 bg-emerald-900/30 border border-emerald-500/30 text-emerald-300 px-4 py-3 rounded-xl text-sm">
                  ...
                  Ãƒâ€šÃ‚Â¡Mensaje enviado! Te responderemos pronto.
                </div>
              )}
              {status === 'error' && (
                <div className="flex items-center gap-3 bg-rose-900/30 border border-rose-500/30 text-rose-300 px-4 py-3 rounded-xl text-sm">
                  ...
                  Hubo un error al enviar. Intenta de nuevo o escrÃƒÆ’Ã‚Â­benos por WhatsApp.
                </div>
              )}
          ...
          <div className="relative group w-230">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-[#B58A4F]/20 shadow-2xl h-110">
              <iframe
                ...
                title="UbicaciÃƒÆ’Ã‚Â³n PERU TOURS HOSPEDAJE"
              ></iframe>
            </div>
          </div>
        </div>
