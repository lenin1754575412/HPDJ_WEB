        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full">
          <div className="max-w-3xl">
            ...
            <p className="mt-8 text-[#F2E7D0]/75 text-lg leading-8 max-w-2xl">
              Nuestro equipo estÃƒÂ¡ disponible para ayudarte a planificar
              tu estadÃƒÂ­a, resolver tus consultas y acompaÃƒÂ±arte en cada
              detalle de tu prÃƒÂ³xima experiencia.
            </p>
          </div>
        </div>
      </section>
